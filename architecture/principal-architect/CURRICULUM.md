...
This document defines the expected learner-facing structure for `ai-infra-principal-architect-learning`.

## Repository Type

- Track type: learning
- Paired solutions repo: `ai-infra-principal-architect-solutions`
...
- Keep module slugs consistent with `ai-infra-principal-architect-solutions`.
