# Exercise 3: Chaos Engineering Application

## Objective

Apply concepts from Chaos Engineering to solve a real-world architecture problem.
...
1. Create a directory: `solutions/exercise-3/`
