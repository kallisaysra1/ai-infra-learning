# High-Availability and Disaster Recovery Architecture - Assessment Quiz
...
**Question**: Which of the following best describes HA Patterns?
...
**Question**: Which of the following are best practices for DR Planning? (Select all that apply)
