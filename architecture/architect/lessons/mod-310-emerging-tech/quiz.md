# Emerging Technologies and Innovation - Assessment Quiz
...
**Question**: Which of the following best describes Emerging AI Hardware?
...
**Question**: Which of the following are best practices for Edge AI? (Select all that apply)
