# Enterprise MLOps Platform Architecture - Assessment Quiz
...
**Question**: Which of the following best describes MLOps Architecture?
...
**Question**: Which of the following are best practices for Model Governance? (Select all that apply)
