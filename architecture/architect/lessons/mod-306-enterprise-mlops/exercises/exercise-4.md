# Exercise 4: Real-time Serving Application

## Objective

Apply concepts from Real-time Serving to solve a real-world architecture problem.
...
1. Create a directory: `solutions/exercise-4/`
