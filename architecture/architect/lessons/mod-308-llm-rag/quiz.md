# LLM Platform and RAG Architecture - Assessment Quiz
...
**Question**: Which of the following best describes LLM Architecture?
...
**Question**: Which of the following are best practices for RAG? (Select all that apply)
