# Exercise 5: Cost Optimization Application

## Objective

Apply concepts from Cost Optimization to solve a real-world architecture problem.
...
1. Create a directory: `solutions/exercise-5/`
