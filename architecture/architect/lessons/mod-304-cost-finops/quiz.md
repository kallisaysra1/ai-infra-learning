# Cost Optimization and FinOps Architecture - Assessment Quiz
...
**Question**: Which of the following best describes FinOps?
...
**Question**: Which of the following are best practices for TCO Analysis? (Select all that apply)
