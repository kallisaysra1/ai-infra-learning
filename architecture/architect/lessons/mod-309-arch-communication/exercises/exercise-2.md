# Exercise 2: Visual Communication Application

## Objective

Apply concepts from Visual Communication to solve a real-world architecture problem.
...
1. Create a directory: `solutions/exercise-2/`
