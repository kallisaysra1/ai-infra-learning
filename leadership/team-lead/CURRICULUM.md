...
This document defines the expected learner-facing structure for `ai-infra-team-lead-learning`.

## Repository Type

- Track type: learning
- Paired solutions repo: `ai-infra-team-lead-solutions`
...
- Keep module slugs consistent with `ai-infra-team-lead-solutions`.
