...
This document defines the expected learner-facing structure for `ai-infra-principal-engineer-learning`.

## Repository Type

- Track type: learning
- Paired solutions repo: `ai-infra-principal-engineer-solutions`
...
- Keep module slugs consistent with `ai-infra-principal-engineer-solutions`.
